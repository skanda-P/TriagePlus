...
export function IntakeMiniForm({ onSubmit }: { onSubmit: (data: any) => void }) {
  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-white dark:bg-slate-800 rounded-lg p-5 border border-frost-gray dark:border-gray-700 mt-4 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          <label className="block text-xs font-medium text-graphite dark:text-gray-300 mb-1">Full Name</label>
          <input 
            required type="text"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-medium text-graphite dark:text-gray-300 mb-1">Age</label>
            <input 
          ...
          <div>
            <label className="block text-xs font-medium text-graphite dark:text-gray-300 mb-1">Gender</label>
            <select 
              className="w-full rounded-md border border-ash dark:border-gray-600 bg-transparent px-3 py-2 text-sm text-charcoal dark:text-white focus:outline-none focus:ring-2 focus:ring-canopy-green/50"
        ...
        <div>
          <label className="block text-xs font-medium text-graphite dark:text-gray-300 mb-1">Contact Number</label>
          <input 
            required type="text" placeholder="+1..."
            className="w-full rounded-md border border-ash dark:border-gray-600 bg-transparent px-3 py-2 text-sm text-charcoal dark:text-white focus:outline-none focus:ring-2 focus:ring-canopy-green/50"

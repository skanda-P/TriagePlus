...
| Slot extraction | Parse symptoms from conversation | ❌ **No** | A Medical NER pipeline (`d4data/biomedical-ner-all`) extracts from what the patient *said*, not from external sources. |
